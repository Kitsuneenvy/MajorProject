...
public class UIPopupList : MonoBehaviour
{
	...
	public bool createdDropDownList = false;
...
public	void OnItemPress (GameObject go, bool isPressed) { if (isPressed) {Select(go.GetComponent<UILabel>(), true);}createdDropDownList = false;}
...
public	void OnClick()
	{	
		if (mChild == null && atlas != null && font != null && items.Count > 1)
		{
			...
			mBackground.name = "BackgroundSprite";
			...
			mHighlight.name = "HighlightSprite";
